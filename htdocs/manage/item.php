...
SQL
    ...
    foreach ($_GET['ingred_id'] as $i => $ingred_id) {
        $optional = $_GET['optional'][$i] ? 'TRUE' : 'FALSE';;
        mysql_query(<<<SQL
INSERT
...
<div style="text-align: center;">
    <form action="/manage/item.php" method="GET">
...
while (($row = mysql_fetch_assoc($results)) !== FALSE) {
    ...
    echo '<li>';
    echo "<div class=\"title\">$row[item_name] <span class=\"cost\">&mdash; $cost <a href=\"/manage/item.php?action=delete&item_id=$row[item_id]\">[delete]</a></span></div>";
